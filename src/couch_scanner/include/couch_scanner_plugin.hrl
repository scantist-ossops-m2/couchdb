...
-define(LOG(LVL, FMT, ARGS, META), couch_scanner_plugin:log(LVL, ?MODULE, FMT, ARGS, maps:merge(META, #{fn => ?FUNCTION_NAME}))).
...
-define(DEBUG(FMT, ARGS, META), ?LOG(debug, FMT, ARGS, META)).
